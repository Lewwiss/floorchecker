...
const Data = ({ floorArr, address }) => {
    ...
    return (
        <div className="mx-auto container flex flex-col justify-center items-center pt-24 pb-20 px-6 3xl:px-0">
            <p className="text-sm font-medium text-slate-600 pt-16">0x148089038088cC49CDcF26e0f96776c25e5CfACd</p>
            <p className="text-4xl font-extrabold text-white pt-10 pb-10">Total: {total} Ξ</p>
            <div className="pb-12">
