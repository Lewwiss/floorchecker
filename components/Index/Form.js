    ...
    return (
        <div className="max-w-xl w-full">
            ...
            <div className="relative w-full flex flex-row justify-center space-x-5 pt-5">
                ...
                <button onClick={() => submitAddress()} className="text-sm text-white font-semibold py-3.5 px-8 bg-primary outline-none flex flex-row items-center duration-200 hover:scale-105 hover:-rotate-1">
                    Check
